...
/*
 * haul  DM2K bitmaps into program address space
 */
#include "dm2k.h"
...
static XImage arc25, bar25, byte25, bezierCurve25, cartesianPlot25, choiceButton25,
	...
	textEntry25, textUpdate25, valuator25, dynSymbol25;
...
void dm2kInitializeImageCache()
{
  ...
  dynSymbol25.width = dynSymbol25_width;
  dynSymbol25.height = dynSymbol25_height;
  dynSymbol25.data = (char *)dynSymbol25_bits;
  dynSymbol25.xoffset = 0;
  dynSymbol25.format = XYBitmap;
  dynSymbol25.byte_order = MSBFirst;
  dynSymbol25.bitmap_pad = 8;
  dynSymbol25.bitmap_bit_order = LSBFirst;
  dynSymbol25.bitmap_unit = 8;
  dynSymbol25.depth = 1;
  dynSymbol25.bytes_per_line = 4;
  dynSymbol25.obdata = NULL;
  XmInstallImage(&dynSymbol25,"dynSymbol25");
